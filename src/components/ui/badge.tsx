  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        homemade: "border-transparent bg-secondary/20 text-secondary",
        budget: "border-transparent bg-warning/20 text-warning-foreground",
        veg: "border-transparent bg-success/20 text-success",
        nonveg: "border-transparent bg-destructive/20 text-destructive",
      },
    },
    defaultVariants: {
      variant: "default",
